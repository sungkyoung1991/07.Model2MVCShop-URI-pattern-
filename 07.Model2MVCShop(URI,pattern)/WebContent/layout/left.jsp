		...
		<table  border="0" cellspacing="0" cellpadding="0" width="159" >	
			<tr>
				<c:if test="${ !empty user }">
					<tr>
						<td class="Depth03">
							<a href="/getUser?userId=${user.userId}" target="rightFrame">개인정보조회</a>
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${user.role == 'admin'}">
					<tr>
						<td class="Depth03" >
							<a href="/listUser" target="rightFrame">회원정보조회</a>
						</td>
					</tr>
				</c:if>
...
<tr>
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			...
			<tr>
				<td class="Depth03">
					<a href="/listPurchase?menu=search"  target="rightFrame">구매이력조회</a>
				</td>
			</tr>
			</c:if>
